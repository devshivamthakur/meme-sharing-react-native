...
const ProfileHeader = (props:ProfileHeaderProps) => {
  const TotalLikes=useMemo(() => {
    return formatNumber(props.total_like||0)
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            for {props.total_posts} uploaded memes
          </Text>
        </View>
      </View>
